...
class VetorOrdenado:
    ...
    def insere(self,vertice):
        ...
        for i in range(self.ultima_posicao + 1): #percorrer todas as posições
            posicao = i
            if(self.valores[i].distancia_objetivo > vertice.distancia_objetivo): # Depois que o valor for maior que o numero que for inserido, ele vai dar um break no for
                break
...
busca_gulosa = Gulosa(grafo.burcharest)
